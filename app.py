...
def sidebar():
    with st.sidebar:
        ...
        navs = [('home','⌂','Dashboard'), ('crop_rec','🌾','Crop Recomendation'), ('pest','🐛','Pest & Disease Diagnosis'), ('weather','🌦','Smart Weather alert'), ('soil','🧪','Soil Health & Nutrients'), ('sustainable','♻️','Sustainable')]
        for k, i, l in navs:
...
def render_home():
    ...
    f_cols = st.columns(5)
    feats = [('crop_rec','🌾','Crop Recomendation'), ('pest','🐛','Pest & Disease'), ('weather','🌦','Weather Alerts'), ('soil','🧪','Soil Health'), ('sustainable','♻️','Sustainable')]
